...
| 效能 | fast 冷啟動首 token ≤ 30s | 通過 | {'model': 'qwen3.5:4b', 'first_token_seconds': 7.638, 'elapsed_seconds': 8.847, 'eval_count': 71, 'tokens_per_second': 58.92, 'load_seconds': 7.483, 'response_characters': 74} |
| 效能 | fast 暖機首 token ≤ 5s | 通過 | {'model': 'qwen3.5:4b', 'first_token_seconds': 0.134, 'elapsed_seconds': 1.301, 'eval_count': 71, 'tokens_per_second': 60.54, 'load_seconds': 0.002, 'response_characters': 74} |
| 效能 | fast 暖機持續生成 ≥ 8 tokens/s | 通過 | {'model': 'qwen3.5:4b', 'first_token_seconds': 0.134, 'elapsed_seconds': 1.301, 'eval_count': 71, 'tokens_per_second': 60.54, 'load_seconds': 0.002, 'response_characters': 74} |
| 效能 | quality 冷啟動首 token ≤ 30s | 通過 | {'model': 'qwen3.5:9b', 'first_token_seconds': 7.983, 'elapsed_seconds': 9.305, 'eval_count': 54, 'tokens_per_second': 40.9, 'load_seconds': 7.818, 'response_characters': 59} |
| 效能 | quality 暖機首 token ≤ 10s | 通過 | {'model': 'qwen3.5:9b', 'first_token_seconds': 0.118, 'elapsed_seconds': 1.43, 'eval_count': 54, 'tokens_per_second': 41.21, 'load_seconds': 0.002, 'response_characters': 59} |
| 效能 | quality 暖機持續生成 ≥ 8 tokens/s | 通過 | {'model': 'qwen3.5:9b', 'first_token_seconds': 0.118, 'elapsed_seconds': 1.43, 'eval_count': 54, 'tokens_per_second': 41.21, 'load_seconds': 0.002, 'response_characters': 59} |
...
```json
{
  ...
  "fast_cold": {
    "model": "qwen3.5:4b",
    "first_token_seconds": 7.638,
    "elapsed_seconds": 8.847,
    "eval_count": 71,
  ...
  "fast_warm": {
    "model": "qwen3.5:4b",
    "first_token_seconds": 0.134,
    "elapsed_seconds": 1.301,
    "eval_count": 71,
    "tokens_per_second": 60.54,
    "load_seconds": 0.002,
    "response_characters": 74
  },
  "quality_cold": {
    "model": "qwen3.5:9b",
    "first_token_seconds": 7.983,
    "elapsed_seconds": 9.305,
    "eval_count": 54,
