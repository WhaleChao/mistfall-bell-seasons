...
| 效能 | fast 冷啟動首 token ≤ 30s | 通過 | {'model': 'qwen3.5:4b', 'first_token_seconds': 7.056, 'elapsed_seconds': 8.237, 'eval_count': 71, 'tokens_per_second': 60.29, 'load_seconds': 6.905, 'response_characters': 74} |
| 效能 | fast 暖機首 token ≤ 5s | 通過 | {'model': 'qwen3.5:4b', 'first_token_seconds': 0.121, 'elapsed_seconds': 1.299, 'eval_count': 71, 'tokens_per_second': 60.34, 'load_seconds': 0.003, 'response_characters': 74} |
| 效能 | fast 暖機持續生成 ≥ 8 tokens/s | 通過 | {'model': 'qwen3.5:4b', 'first_token_seconds': 0.121, 'elapsed_seconds': 1.299, 'eval_count': 71, 'tokens_per_second': 60.34, 'load_seconds': 0.003, 'response_characters': 74} |
| 效能 | quality 冷啟動首 token ≤ 30s | 通過 | {'model': 'qwen3.5:9b', 'first_token_seconds': 8.323, 'elapsed_seconds': 9.677, 'eval_count': 54, 'tokens_per_second': 39.95, 'load_seconds': 8.146, 'response_characters': 59} |
| 效能 | quality 暖機首 token ≤ 10s | 通過 | {'model': 'qwen3.5:9b', 'first_token_seconds': 0.127, 'elapsed_seconds': 1.474, 'eval_count': 54, 'tokens_per_second': 40.08, 'load_seconds': 0.004, 'response_characters': 59} |
| 效能 | quality 暖機持續生成 ≥ 8 tokens/s | 通過 | {'model': 'qwen3.5:9b', 'first_token_seconds': 0.127, 'elapsed_seconds': 1.474, 'eval_count': 54, 'tokens_per_second': 40.08, 'load_seconds': 0.004, 'response_characters': 59} |
...
```json
{
  ...
  "fast_cold": {
    "model": "qwen3.5:4b",
    "first_token_seconds": 7.056,
    "elapsed_seconds": 8.237,
    "eval_count": 71,
    "tokens_per_second": 60.29,
    "load_seconds": 6.905,
    "response_characters": 74
  },
  "fast_warm": {
    "model": "qwen3.5:4b",
    "first_token_seconds": 0.121,
    "elapsed_seconds": 1.299,
    "eval_count": 71,
    "tokens_per_second": 60.34,
    "load_seconds": 0.003,
    "response_characters": 74
  },
  "quality_cold": {
    "model": "qwen3.5:9b",
    "first_token_seconds": 8.323,
    "elapsed_seconds": 9.677,
    "eval_count": 54,
    "tokens_per_second": 39.95,
    "load_seconds": 8.146,
    "response_characters": 59
  },
  "quality_warm": {
    "model": "qwen3.5:9b",
    "first_token_seconds": 0.127,
    "elapsed_seconds": 1.474,
    "eval_count": 54,
    "tokens_per_second": 40.08,
    "load_seconds": 0.004,
    "response_characters": 59
  },
  "fast_assist": {
