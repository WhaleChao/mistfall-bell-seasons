...
func _run() -> void:
	...
	var payload := {
		...
		"algorithm":"cell-bounded four-neighbour background flood fill, then lossless connected-component repack with 16px minimum padding",
